...
const Header = ({
  ...
  // 🔹 Cargar datos del usuario con su imagen
  useEffect(() => {
              ...
              {profileOpen && (
                ...
                >
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-base hover:bg-light-primary/10 transition"
                  >
                    Perfil
                  </button>
                  <button
                    onClick={logOut}
                    className="w-full text-left px-4 py-2 text-base text-light-danger hover:bg-light-danger/10 dark:hover:bg-dark-danger/20 transition"
                  >
                    Cerrar sesión
                  </button>
                </motion.div>
          ...
          >
            <div className="py-3 px-4 space-y-2 text-center">
              ...
              {!currentUser ? (
                ...
                <>
                  {isUser && (
                    <NavLink to="/proyectos" className={(navData) => getNavLinkClasses(navData) + ' block'} onClick={handleCloseMobileMenu}>
                      Mis Proyectos
                    </NavLink>
                  )}

                  {isUser && (
                    <NavLink to="/chat" className={(navData) => getNavLinkClasses(navData) + ' block'} onClick={handleCloseMobileMenu}>
                      Chat
                    </NavLink>
                  )}
                  ...
                  <button
                    ...
                    className="w-full text-center px-4 py-2 text-base text-dark-surface dark:text-light-surface hover:bg-light-primary/10 transition"
                  >
                    Perfil
                  </button>
