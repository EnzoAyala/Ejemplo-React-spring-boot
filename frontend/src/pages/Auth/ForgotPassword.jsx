...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage('codigo enviado a tu correo');
            navigate('/verify-code', { state: { email}});    // Redirige con el email para enviar el código
        } catch (error) {
        ...
        <div className="flex justify-center items-center min-h-[calc(100vh-150px)] py-10">
            <div className="w-full max-w-md bg-light-surface dark:bg-dark-surface p-8 rounded-2xl shadow-lg transition-colors duration-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {message && <p className="mt-4 p-3 rounded-md text-center text-sm bg-light-danger/10 text-light-danger dark:text-dark-danger">{message}</p>}
