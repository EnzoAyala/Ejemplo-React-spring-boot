...
const Home = () => {
    ...
    return (
        <main className="min-h-screen bg-light-surface dark:bg-dark-surface flex flex-col items-center justify-center px-6 py-16 transition-colors duration-500 ease-in-out w-full">
            <section className="w-full text-center p-12 md:p-20 bg-light-surface dark:bg-dark-surface rounded-3xl shadow-2xl">
