...
public class UserWebSocketEventListener {
    ...
    public void handleNewUserRegistration(OnNewUserRegisteredEvent event) {
        ...
        // Converir el objeto a User a UserResponse para enviar solo datos relevantes y reducir la carga
        ...
        // Enviar el nuevo usuario (en formato UserResponse) a todos los suscriptores del tema /topic/user-updates
